#Kayani_Mehtab_es50_v2.sh
#Exercise number 50, Submission number 2
#Mehtab, Kayani
...
gawk --re-interval '{gsub(/[\- ]/,"");print $0; }' | gawk --re-interval '{if (substr($0,1,1) == "+") print(substr($0,1,6))"-"(substr($0,7,9)); else print(substr($0,1,3))"-"(substr($0,4,6))}' > $2
exit 0
