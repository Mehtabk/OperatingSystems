#Kayani_Mehtab_es49b_v2.sh
#Exercise number 49b, Submission number 2
#Mehtab, Kayani
...
cat $1 | gawk --re-interval '/^081[\- ]?76[0-9]{5}$/'| gawk --re-interval '{gsub(/[\- ]/,"");print $0; }' | gawk --re-interval '{print(substr($0,1,4))"-"(substr($0,5,6))}'  > $2
